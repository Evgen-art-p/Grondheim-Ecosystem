...
# PATCH_KTO_ZDES_BYVAET — реверс-транспорт: локация спрашивает жителей, кто здесь
...
def _image_url(dom: "Path | None", p: dict) -> str:
    ...
    with ui.element("div").classes("app-container"):
        ...
        with ui.element("div").classes("area-right"):
            with ui.element("div").classes("right-col"):
                ...
                # PATCH_KTO_ZDES_BYVAET: живой скан по прописке — не список, а вопрос жителям
                with ui.element("div").classes("glass").style("flex-shrink:0;"):
