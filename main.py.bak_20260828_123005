...
# ── МАЯК ПРОБУЖДЕНИЯ — выход города наружу ── MAYAK_KABINET_V2
...
# ── АКАДЕМИЯ — Замок Сов (школа города) ── AKADEMIA_KABINET_V1
...
# ── АРХИВ ГОРОДА — Хранитель (сейчас Лока) ── ARKHIV_MAIN_ROUTE_V1
