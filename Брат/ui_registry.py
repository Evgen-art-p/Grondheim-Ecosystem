            ...
            with ui.tab_panel("form").classes("reg-form").style("padding: 0"):
                ...
                with ui.element("div").classes("reg-block dna-block") as _agent_block:
                    ...
                    with ui.element("div").classes("reg-block-body"):
                        ...
                        # Порода убрана из формы рождения — UBRAT_BLOCK2_I_PORODU_V1
                ...
                with ui.element("div").style(
                  ...
                  with ui.element("div").style("display:flex;flex-direction:column;gap:0"):
                    ...
                    # Блоки 1,3 (Идентификация, Физическое) — UBRAT_BLOCK2_I_PORODU_V1
                  ...
                  with ui.element("div").style("display:flex;flex-direction:column;gap:0"):
                    ...
                    # Блоки 4,5,6 (Глубинная суть, Динамика, Печать) — UBRAT_BLOCK2_I_PORODU_V1
                ...
                def save_object():
                    ...
                    # Проверка уникальности резидента убрана вместе с породой — UBRAT_BLOCK2_I_PORODU_V1
